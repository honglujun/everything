...
//    private RedisUtil() {
//        if (pool == null) {
//            System.out.println("创建redis连接池开始");
//            LOGGER.info("redis连接处初始化开始");
...
//            // pool = new JedisPool(config, "127.0.0.1", 6379, 100000, null,
//            // 1);//最后一个参数指定存储在db1中
//            LOGGER.info("redis连接处初始化结束");
//            System.out.println("创建redis连接池成功");
//        }
//
//    }
//
...
//
//
//    public Set<String> delAllByPattern(String pattern) {
//        Jedis jedis = null;
//        Set<String> res = null;
//        try {
//            jedis = pool.getResource();
//            List<String> keys = new ArrayList<String>();
//            List<String> thisJKeys = new ArrayList<String>();
//            String nextCurSor = "0";
...
//                    thisJKeys.addAll(keyList);
//                }
//            } while (Integer.parseInt(nextCurSor) > 0);
//            if (thisJKeys.size() > 0) {
//                String[] keyArr = thisJKeys.toArray(new String[0]);
//                jedis.del(keyArr);
//                keys.addAll(thisJKeys);
//            }
//
//        } catch (Exception e) {
//
...
//*
//     * <p>
//     * 向redis存入key和java对象类型的value,并释放连接资源
//     * </p>
//     * <p>
//     * 如果key已经存在 则覆盖
//     * </p>
...
//        if (jedis != null) {
//            // pool.returnResource(jedis);旧版本
//            jedis.close();// 3.0以后版本使用
//
//        }
//    }
//
